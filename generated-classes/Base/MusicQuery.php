 ...
 *
 * @method     \GendersQuery|\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MusicQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\MusicQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'rockolaweb', $modelName = '\\Music', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Genders object
     *
     * @param \Genders|ObjectCollection $genders The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByGenders($genders, $comparison = null)
    {
        if ($genders instanceof \Genders) {
            ...
            throw new PropelException('filterByGenders() only accepts arguments of type \Genders or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \GendersQuery A secondary query class using the current class as primary query
     */
    public function useGendersQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinGenders($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Genders', '\GendersQuery');
    }
