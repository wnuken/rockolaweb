...
abstract class Music implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Rockolaweb\\Map\\MusicTableMap';
    ...
    /**
     * Initializes internal state of Rockolaweb\Base\Music object.
     */
     ...
     * @return $this|\Rockolaweb\Music The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 6; // 6 = MusicTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Rockolaweb\\Music'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Rockolaweb\Music The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Rockolaweb\Music (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Rockolaweb\Music Clone of current object.
     * @throws PropelException
     */
