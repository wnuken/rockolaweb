 ...
 * @method     ChildAuthorQuery orderByNationality($order = Criteria::ASC) Order by the nationality column
 *
 * @method     ChildAuthorQuery groupById() Group by the id column
 * @method     ChildAuthorQuery groupByName() Group by the name column
 * @method     ChildAuthorQuery groupByNationality() Group by the nationality column
 *
 ...
 *
 * @method     ChildAuthorQuery leftJoinMusic($relationAlias = null) Adds a LEFT JOIN clause to the query using the Music relation
 * @method     ChildAuthorQuery rightJoinMusic($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Music relation
 * @method     ChildAuthorQuery innerJoinMusic($relationAlias = null) Adds a INNER JOIN clause to the query using the Music relation
 *
 ...
 * @method     ChildAuthor findOneByNationality(string $nationality) Return the first ChildAuthor filtered by the nationality column *
 ...
 * @method     ChildAuthor requireOneByNationality(string $nationality) Return the first ChildAuthor filtered by the nationality column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildAuthor[]|ObjectCollection findByNationality(string $nationality) Return ChildAuthor objects filtered by the nationality column
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Rockolaweb\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Rockolaweb\\Author', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, nationality FROM author WHERE id = :p0';
        try {
    ...
    public function filterByNationality($nationality = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AuthorTableMap::COL_NATIONALITY, $nationality, $comparison);
    }
    ...
    public function filterByMusic($music, $comparison = null)
    {
        if ($music instanceof \Rockolaweb\Music) {
            return $this
                ->addUsingAlias(AuthorTableMap::COL_ID, $music->getAuthorId(), $comparison);
