...
use Rockolaweb\Author;
use Rockolaweb\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Rockolaweb.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Rockolaweb\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Rockolaweb.Author';
     ...
     */
    const COL_NAME = 'author.name';

    /**
     * the column name for the nationality field
     */
    const COL_NATIONALITY = 'author.nationality';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Nationality', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'nationality', ),
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID, AuthorTableMap::COL_NAME, AuthorTableMap::COL_NATIONALITY, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'nationality', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Nationality' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'nationality' => 2, ),
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID => 0, AuthorTableMap::COL_NAME => 1, AuthorTableMap::COL_NATIONALITY => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'nationality' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Rockolaweb\\Author');
        $this->setPackage('Rockolaweb');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 255, null);
        $this->addColumn('nationality', 'Nationality', 'VARCHAR', true, 128, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AuthorTableMap::COL_NATIONALITY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Rockolaweb\Author) { // it's a model object
