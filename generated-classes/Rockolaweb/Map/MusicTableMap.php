...
use Rockolaweb\Music;
use Rockolaweb\MusicQuery;
...
class MusicTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Rockolaweb.Map.MusicTableMap';
     ...
     */
    const OM_CLASS = '\\Rockolaweb\\Music';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Rockolaweb.Music';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Rockolaweb\\Music');
    ...
    {
        $this->addRelation('Genders', '\\Rockolaweb\\Genders', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':gender_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\Rockolaweb\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Rockolaweb\Music) { // it's a model object
